...
/*   Updated: 2023/02/18 11:39:47 by gimartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "ClapTrap.hpp"

ClapTrap::ClapTrap() : _hit_Points(this->_max_Hit), _AD(this->_max_AD), _Energy(this->_max_Energy)
{
	this->_Name = "NoName";
	std::cout << BOLDGREEN << _Name << " join the fight!" << RESET << std::endl;
}

ClapTrap::ClapTrap(std::string _Name) : _hit_Points(this->_max_Hit), _AD(this->_max_AD), _Energy(this->_max_Energy)
{
	this->_Name = _Name;
	std::cout << BOLDGREEN << _Name << " join the fight!" << RESET << std::endl;
}
