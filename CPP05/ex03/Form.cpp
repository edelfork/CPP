...
/*   Updated: 2022/08/10 12:24:08 by gimartin         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
Form::Form(const std::string name, const std::string& target, const int grade, const int gradeExec)
: _isSigned(false), _name(name), _grade(grade), _gradeExec(gradeExec), _target(target)
{    
}
...
const std::string Form::getTarget()
{
	return this->_target;
}
